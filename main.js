...
function preload(){
ball_touch = loadSound("touch.wav");
...
function restart(){
  ...
  playerscore = 0;
  loop();
  document.getElementById("game_status").innerHTML = "Reload The Page Or Click On The Restart Button To Play Again.";
}
...
if(pcscore ==4){
    ...
    text("Press The Restart Button To Start Again!",width/2,height/2+30)
    noLoop();
    pcscore = 0;
}
